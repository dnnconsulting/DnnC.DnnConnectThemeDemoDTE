...
<%@ Register TagPrefix="dnn" TagName="DnnThemeEditor" src="~/DesktopModules/DnnThemeEditor/View.ascx" %>


<!--#include file="layouts/_includes_top.ascx" -->  
<link id="themeeditor_css" rel="stylesheet" href="/DesktopModules/DnnThemeEditor/theme.ashx?t=<%= PortalSettings.Current.ActiveTab.TabId %>" />
...
<dnn:DnnThemeEditor id="DnnThemeEditor" runat="server" Distance="200px" Color="dark" EditorUserRole="" />